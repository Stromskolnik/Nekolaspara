...
def s1d1():
       while True:
        ...
        PLAY_BACK = Button(image=None, pos=(1650, 100), 
                            text_input="Hlavní Menu", font=get_font(40), base_color="White", hovering_color="Green")
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("asety/startus.png"), pos=(1650, 300), 
                            text_input="Nová hra", font=get_font(50), base_color="#732c06", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("asety/nastus.png"), pos=(1650, 500), 
                            text_input="Nastavení", font=get_font(50), base_color="#732c06", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("asety/koncus.png"), pos=(1650, 700), 
