...
house=pygame.image.load("asety/house.jpg")
...
MOKNO_BUTTONV= Button(image=None, pos=((Width/100)*22.135416, (Height/100)*67.12962962963),
                            text_input="Viktor", font=font_meno, base_color="White", hovering_color="White")
#semeny
def s1():
...
def s193():
    while True:
        ...
        PLAY_BACK.update(SCREEN)
        SAKON1_BUTTON= Button(image=(resized_vyberbutton), pos=((Width/100)*26.0416,(Height/100)*55.55), 
                                    text_input="Pouslouchat dál", font=font_vyber, base_color="White", hovering_color="#4e61de")
        SAKON2_BUTTON= Button(image=(resized_vyberbutton), pos=((Width/100)*65.10416,(Height/100)*55.55), 
                                    text_input="Zastřelit se", font=font_vyber, base_color="White", hovering_color="#4e61de")
        SAKON1_BUTTON.changeColor(PLAY_MOUSE_POS)
        SAKON2_BUTTON.changeColor(PLAY_MOUSE_POS)
        SAKON1_BUTTON.update(SCREEN)
        SAKON2_BUTTON.update(SCREEN)
...
def sls3():
    while True:
        PLAY_MOUSE_POS = pygame.mouse.get_pos();SCREEN.fill("black");SCREEN.blit(resized_ls, (0, 0));f = open("save3.txt", "w");f.close();pygame.mixer.music.stop()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit();sys.exit()
            s183()
...
def s196():
    while True:
        ...
        PLAY_MOUSE_POS = pygame.mouse.get_pos()
        PLAY_BACK;DOKNO_BUTTON;MOKNO_BUTTONN;DALSI_BUTTON
        imp1 = pygame.image.load('postavy/nekolas.png').convert()                                                           #PB  
        SCREEN.blit(imp1, ((Width/100)*32.8125, (Height/100)*18.518))
        imp3 = pygame.image.load('postavy/strom.png').convert_alpha()                                                           
        SCREEN.blit(imp3, ((Width/100)*52.083, (Height/100)*18.518))
        imp2 = pygame.image.load('postavy/cednik.png').convert()                                                            
...
def s197():
    while True:
        ...
        imp3 = pygame.image.load('postavy/strom.png').convert_alpha()                                                           
        SCREEN.blit(imp3, ((Width/100)*52.083, (Height/100)*18.518))
        imp2 = pygame.image.load('postavy/cednik.png').convert()                                                           #CEDNIK 
        SCREEN.blit(imp2, ((Width/100)*5.2083,(Height/100)*15.740))
...
def s198():
        while True:
            ...
            DOKNO_BUTTON= Button(image=(resized_mdva), pos=((Width/100)*40.625,(Height/100)*46.296), 
                                text_input="", font=font_meno, base_color="White", hovering_color="Green")
            imp1 = pygame.image.load('postavy/nekolas.png').convert()                                                           #NEKOLAS 
            SCREEN.blit(imp1, ((Width/100)*32.8125, (Height/100)*15.740))
            imp3 = pygame.image.load('postavy/strom.png').convert_alpha()                                                           
            SCREEN.blit(imp3, ((Width/100)*52.083, (Height/100)*18.518))
            imp2 = pygame.image.load('postavy/cednik.png').convert()                                                           
...
def s199():
    while True:
        ...
        imp3 = pygame.image.load('postavy/strom.png').convert_alpha()                                                           
        SCREEN.blit(imp3, ((Width/100)*52.083, (Height/100)*15.740))
        imp2 = pygame.image.load('postavy/cednik.png').convert()                                                           #STROM
        SCREEN.blit(imp2, ((Width/100)*5.2083,(Height/100)*18.518))
        imp1 = pygame.image.load('postavy/nekolas.png').convert()                                                           
        SCREEN.blit(imp1, ((Width/100)*32.8125, (Height/100)*15.740))
        DALSI_BUTTON.update(SCREEN)
...
def sls4():
    while True:
        PLAY_MOUSE_POS = pygame.mouse.get_pos();SCREEN.fill("black");SCREEN.blit(resized_ls, (0, 0));f = open("save4.txt", "w");f.close()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit();sys.exit()
            s215()
...
def smapa():
    while True:
        ...
        PLAY_BACK
        SCREEN.blit(resized_bg23, (0, 0))
        VYB_BUTTONG =Button(image=(house), pos=((Width/100)*21.875,(Height/100)*55.55), 
                                                text_input="", font=font_vyber, base_color="White", hovering_color="#4e61de")
        VYB_BUTTONS =Button(image=(house), pos=((Width/100)*48.9583,(Height/100)*55.55), 
                                                text_input="", font=font_vyber, base_color="White", hovering_color="#4e61de")
        VYB_BUTTONP =Button(image=(house), pos=((Width/100)*76.0416,(Height/100)*55.55), 
                                                text_input="", font=font_vyber, base_color="White", hovering_color="#4e61de")
        VYB_BUTTONG.changeColor(PLAY_MOUSE_POS)
        VYB_BUTTONP.changeColor(PLAY_MOUSE_POS)
        VYB_BUTTONS.changeColor(PLAY_MOUSE_POS)
...
def sdum21():
    while True:
        ...
        PLAY_BACK.changeColor(PLAY_MOUSE_POS)
        MOKNO_BUTTON= Button(image=None, pos=((Width/100)*22.135416, (Height/100)*67.12962962963),
                            text_input="Obyvatel Čeradic", font=font_meno, base_color="White", hovering_color="White")
        PLAY_BACK.update(SCREEN)
        DOKNO_BUTTON.update(SCREEN)
        MOKNO_BUTTON.update(SCREEN)
...
def sdum2vyber():
    while True:
        ...
        SCREEN.blit(imp2, ((Width/100)*5.2083,(Height/100)*18.518))
        VYB_BUTTONG =Button(image=(resized_vyberbutton), pos=((Width/100)*21.875,(Height/100)*55.55), 
                                            text_input="pět tisíc", font=font_vyber, base_color="White", hovering_color="#4e61de")
        VYB_BUTTONS =Button(image=(resized_vyberbutton), pos=((Width/100)*48.9583,(Height/100)*55.55), 
                                            text_input="dvacet pět tisíc", font=font_vyber, base_color="White", hovering_color="#4e61de")
        VYB_BUTTONP =Button(image=(resized_vyberbutton), pos=((Width/100)*76.0416,(Height/100)*55.55), 
                                            text_input="padesát tisíc", font=font_vyber, base_color="White", hovering_color="#4e61de")
        VYB_BUTTONG.changeColor(PLAY_MOUSE_POS)
        VYB_BUTTONP.changeColor(PLAY_MOUSE_POS)
        VYB_BUTTONS.changeColor(PLAY_MOUSE_POS)
        VYB_BUTTONG.update(SCREEN)
...
def sdum31():
        while True:
            ...
            DOKNO_BUTTON= Button(image=(resized_mdva), pos=((Width/100)*40.625,(Height/100)*46.296), 
                                text_input="", font=font_meno, base_color="White", hovering_color="Green")
            imp1 = pygame.image.load('postavy/viktor.png').convert()                                                           #NEKOLAS 
            SCREEN.blit(imp1, ((Width/100)*32.8125, (Height/100)*15.740))
            imp3 = pygame.image.load('postavy/strom.png').convert_alpha()                                                           
            SCREEN.blit(imp3, ((Width/100)*52.083, (Height/100)*18.518))
            imp2 = pygame.image.load('postavy/cednik.png').convert()                                                           
...
def POMOC():
    ...
    save4=os.path.exists("save4.txt")
    if save4:
        def main_menu5():
            while True:
