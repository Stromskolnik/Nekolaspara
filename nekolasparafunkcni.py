...
def s222():
        while True:
            SCREEN.blit(resized_bg1, (0, 0));MOKNO_BUTTONN  #zmenise topodtimne
            PLAY_MOUSE_POS = pygame.mouse.get_pos();PLAY_BACK;DALSI_BUTTON;DOKNO_BUTTON= Button(image=(resized_mdva), pos=((Width/100)*40.625,(Height/100)*46.296),text_input="", font=font_meno, base_color="White", hovering_color="Green") 
